...
internal static class WebRequest
{
    ...
    public static async Task<GenericResponse<int?>> Watch(this Bot bot, ulong steamId, ulong seconds = 900)
    {
        ...
        thread.Start();
        return new GenericResponse<int?>(true, Langs.Success, viewersNum);
    }
    ...
    public static async Task<GenericResponse<int?>> Chat(this Bot bot, ulong steamId, string message)
    {
        ...
        return sendSuccess ? new GenericResponse<int?>(sendSuccess, Langs.Success, viewersNum) : new GenericResponse<int?>(sendSuccess, "发送弹幕失败", viewersNum);
    }
